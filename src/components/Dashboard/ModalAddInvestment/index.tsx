...
interface IModalAddWallet {
    ...
    setModalAddInvestmentChooseType : React.Dispatch<React.SetStateAction<boolean>>
...
const ModalAddInvestment : React.FC <IModalAddWallet> = ({setOpen, children, setChildCreateAccount, open, childCreateAccount, setModalAddInvestmentChooseType}) => {

    const onClickHandler = () => {
        setModalAddInvestmentChooseType(true)
        setOpen(false)
    }
        ...
        <DialogContent className='bg-white max-w-[95%]'>
            ...
            <DialogTitle className='text-center'>
                <FredokaTitle className='font-bold text-lg'>
                    Select one of your children to set a new investment
                </FredokaTitle>
            </DialogTitle>
            <DialogDescription>
...
export default ModalAddInvestment